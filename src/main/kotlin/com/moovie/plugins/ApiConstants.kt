...
object ApiConstants {
    ...
    const val CC_COOKIE = "" // Placeholder for BuildConfig.CC_COOKIE
    const val CINE_API = "" // Placeholder for BuildConfig.CINE_API
    const val CASTLE_API = "" // Placeholder for BuildConfig.CASTLE_API
    ...
    // ── 3. Dynamic APIs ──────────────────────────────────────────
    val protonmoviesAPI get() = api("protonmovies").ifEmpty { "https://protonmovies.lat" }
    val fourkhdhubAPI get() = api("4khdhub").ifEmpty { "https://4khdhub.one" }
    val moviesdriveAPI get() = api("moviesdrive").ifEmpty { "https://moviesdrive.info" }
    val moviesmodAPI get() = api("moviesmod").ifEmpty { "https://moviesmod.day" }
    val uhdmoviesAPI get() = api("uhdmovies").ifEmpty { "https://uhdmovies.tax" }
    val vegamoviesAPI get() = api("vegamovies").ifEmpty { "https://vegamovies.mx" }
    val bollyflixAPI get() = api("bollyflix").ifEmpty { "https://bollyflix.moscow" }
    val hianimeAPI get() = api("hianime").ifEmpty { "https://hianime.to" }
    val multimoviesAPI get() = api("multimovies").ifEmpty { "https://multimovies.shop" }
    val movies4uAPI get() = api("movies4u").ifEmpty { "https://movies4u.it" }
    val netflixAPI get() = api("netflix").ifEmpty { "https://netflix.mom" }
    val netflix2API get() = api("netflix2").ifEmpty { "https://net-flix.bid" }
    val rogmoviesAPI get() = api("rogmovies").ifEmpty { "https://rogmovies.quest" }
    val skymoviesAPI get() = api("skymovies").ifEmpty { "https://skymovieshd.ink" }
    val topmoviesAPI get() = api("topmovies").ifEmpty { "https://topmovies.zip" }
    val hdmovie2API get() = api("hdmovie2").ifEmpty { "https://hdmovie2.rest" }
